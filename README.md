...
2. [X] Render each team's current score that is in state to the DOM.
3. [X] Be able to click the different buttons to increment the appropriate team's score by the correct amount
